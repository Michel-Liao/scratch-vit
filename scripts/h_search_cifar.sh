...
RESULTS_DIR="vit_cifar10_search_results"
mkdir -p $RESULTS_DIR
...
EPOCHS=7
TEST_INTERVAL=1
NUM_TRIALS=35  # Number of random trials per learning rate
...
num_blocks_min=4
num_blocks_max=12
patch_sizes=(4 8 16)  # Discrete choices for patch size
learning_rates=(1e-4 1e-5)  # Grid search values
